...
public class TextureLoader
{
	...
	public Texture getTexture(String resourceName)
	{
		...
		tex = getTexture(resourceName, GL11.GL_TEXTURE_2D, GL11.GL_RGBA8,
			...
			int dstPixelFormat, int minFilter, int magFilter)
	{
		...
		GLU.gluBuild2DMipmaps(target, 4, get2Fold(bufferedImage.getWidth()),
			...
			Texture texture)
	{
		...
		if (bufferedImage.getColorModel().hasAlpha())
		{
			...
			// texImage = new BufferedImage(texWidth, texHeight,
		...
		byte[] data = ((DataBufferByte) (texImage.getData().getDataBuffer()))
				.getData();
