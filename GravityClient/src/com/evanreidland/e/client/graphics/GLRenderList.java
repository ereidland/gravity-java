...
public class GLRenderList extends RenderList {
	...
	public void addTri(Vertex a, Vertex b, Vertex c) {
		...
		GL11.glNormal3f((float)a.normal.x, (float)a.normal.y, (float)a.normal.z);
		...
		GL11.glNormal3f((float)b.normal.x, (float)b.normal.y, (float)b.normal.z);
		...
		GL11.glNormal3f((float)c.normal.x, (float)c.normal.y,(float) c.normal.z);
