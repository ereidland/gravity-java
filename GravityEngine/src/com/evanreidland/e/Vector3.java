...
public class Vector3
{
	...
	/*
	 * public Vector3 getAngle() { return new Vector3( -Math.atan2(Math.sqrt(x*x
	 * + y*y), z) + Math.PI, 0, Math.atan2(y, x) - Math.PI/2f); }
	 */
	
	/*
	 * public Vector3 getAngle() { double len = getLength(); return new Vector3(
	 * Math.atan2(z, len), 0, Math.atan2(x, y)); }
	 */
