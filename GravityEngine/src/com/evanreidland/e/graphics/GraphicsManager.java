...
public abstract class GraphicsManager
{
	...
	public abstract void passListToRenderData(double[] list, int numVerts,
			RenderList rlist);
	...
	public abstract void putTranslation(Vector3 offset, Vector3 scale,
			Vector3 angle);
	
	public abstract void endTranslation();
	
	public abstract void setClipping(double x, double y, double width,
			double height);
