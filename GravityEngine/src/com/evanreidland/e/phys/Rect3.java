...
public class Rect3 implements Bitable
{
	...
	{
		if (Math.abs(a.x + b.x - other.a.x - other.b.x) < (b.x - a.x
				+ other.b.x - other.a.x))
			if (Math.abs(a.y + b.y - other.a.y - other.b.y) < (b.y - a.y
					+ other.b.y - other.a.y))
				if (Math.abs(a.z + b.z - other.a.z - other.b.z) < (b.z - a.z
						+ other.b.z - other.a.z))
					return true;
		return false;
	}
	...
	public boolean containsPoint(Vector3 point)
	{
		return point.x >= a.x && point.y >= a.y && point.z >= a.z
				&& point.x <= b.x && point.y <= b.y && point.z <= b.z;
	}
