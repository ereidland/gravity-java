...
public abstract class Function
{
	...
	// TODO finish coding.
	/*
	 * public static class MethodBased extends Function { public static enum
	 * ObjectType { Variable, Value, Int, Double, String, Stack, Null, }
	 * 
	 * private ObjectType rtype; private Object object;
	 * 
	 * ObjectType[] argTypes;
	 * 
	 * public static ObjectType toType(Type t) {
	 * System.out.println(t.toString()); return ObjectType.Null; }
	 * 
	 * public Value Call(Stack args) { return new Value(); } public
	 * MethodBased(String name, Method m, Object object) { super(name);
	 * 
	 * Type[] types = m.getGenericParameterTypes(); argTypes = new
	 * ObjectType[types.length]; } }
	 * 
