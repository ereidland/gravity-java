...
public class E2DApplication implements AppletStub {
	private Applet applet;
	private Frame frame;
	
	public static E2DApplication active;
	
	public int width, height;
	public E2DApplication(Applet applet) {
		this.applet = applet;
		width = 640;
		height = 480;
	}
	...
	public void switchApplet(Applet applet) {
		...
		frame.add(applet);
		applet.setStub(this);
		applet.resize(frame.getWidth(), frame.getHeight());
		applet.init();
		applet.start();
	}
